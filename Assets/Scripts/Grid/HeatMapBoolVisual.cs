...
public class HeatMapBoolVisual : MonoBehaviour
{
    ...
    public void SetGrid(GridMap<bool> grid)
    {
        this.grid = grid;
        UpdateHeatMapBoolVisual();

        grid.OnGridValueChanged += GridMap_OnGridValueChanged;
    }

    private void GridMap_OnGridValueChanged(object sender, GridMap<bool>.OnGridValueChangedEventArgs e)
    {
    ...
    private void UpdateHeatMapBoolVisual()
    {
