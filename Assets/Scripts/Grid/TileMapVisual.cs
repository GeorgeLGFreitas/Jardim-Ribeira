...
public class TileMapVisual : MonoBehaviour
{
    ...
    public void SetGrid(Tilemap tilemap, GridMap<Tilemap.TilemapObject> grid)
    {
        this.grid = grid;
        UpdateHeatMapVisual();
    ...
    private void GridMap_OnGridValueChanged(object sender, GridMap<Tilemap.TilemapObject>.OnGridValueChangedEventArgs e)
    {
